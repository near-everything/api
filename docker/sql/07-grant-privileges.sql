...
-- to tags
grant select,insert,update,delete on table everything.tag to everything_user;
grant select,insert,update,delete on table everything.tag to everything_app;
